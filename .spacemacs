...
`dotspacemacs/user-config' first."
  (setenv "WORKON_HOME" "/home/eceftl10/anaconda3/envs")
  )
...
you should place your code here."
  (setq org-agenda-files (list "~/Research/research.org"))
  )
